    ...
    */
    ...
    class C_Offroad_02_unarmed_F {
        ...
        textures[] = {
			...
			{ "Polizei", "cop", {
	            "textures\cop\polizei_offroad2.paa"
            } }
        };
    };
    ...
    class B_MRAP_01_hmg_F {
        ...
        textures[] = {
            { "Polizei", "cop", {
                "textures\cop\polizei_hunter.paa"
            }, "" }
        };
    };
    ...
    class C_Offroad_01_F {
        ...
        textures[] = {
			...
			{ "Weed", "civ", {
                "textures\civ\Offroad_weed.paa"
            }, "" },
            { "Taxi", "civ", {
                "#(argb,8,8,3)color(0.6,0.3,0.01,1)"
            }, "" },
            { "Polizei", "cop", {
                "textures\cop\polizei_offroad.paa"
            }, "" },
			{ "Medic", "med", {
                "textures\medic\MED_offroader.paa"
            }, "" }
        };
    };
...
*/
    ...
    class C_Hatchback_01_sport_F {
        ...
        textures[] = {
            ...
            { "Polizei", "cop", {
               "textures\cop\polizei_hatchback.paa"
            }, "" },
			{ "Medic", "med", {
                "\a3\soft_f_gamma\Hatchback_01\data\hatchback_01_ext_sport01_co.paa"
            }, "" }
    ...
    class C_SUV_01_F {
        ...
        textures[] = {
			...
			{ "Galaxy", "civ", {
                "textures\civ\SUV_Galaxy.jpg"
            }, "" },
			{ "Limonengrün", "civ", {
                "textures\civ\SUV_Lemongruen.paa"
            }, "" },
            { "Polizei", "cop", {
                "textures\cop\polizei_suv.paa"
            }, "" },
			{ "Medic", "med", {
    ...
    class C_Van_01_transport_F {
        ...
        textures[] = {
			...
			{ "Blau", "civ", {
                "textures\civ\Truck_blau_haus.paa"
            }, "" },
			{ "Grün", "civ", {
                "textures\civ\Truck_gruen_haus.paa"
            }, "" },
            { "Rot", "civ", {
    ...
    class B_Heli_Light_01_F {
        ...
        textures[] = {
            { "Polizei", "cop", {
                "textures\cop\polizei_hummingbird.paa"
            }, "" },
            { "Sheriff", "civ", {
            ...
            { "Medic", "med", {
                "textures/med/medic_littlebird.jpg"
            }, "" }
        };
    };
