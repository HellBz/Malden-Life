...
_licenseDealers = [license_shop_1];
{
	...
	_x addAction[format ["<t color='#FF5900'>" + "%1 ($%2)",localize (getText(missionConfigFile >> "Licenses" >> "gold" >> "displayName")), [(getNumber(missionConfigFile >> "Licenses" >> "gold" >> "price"))] call life_fnc_numberText],life_fnc_buyLicense,"gold",0,false,false,"",' !license_civ_gold && playerSide isEqualTo civilian '];this addAction[format ["%1 ($%2)",localize (getText(missionConfigFile >> "Licenses" >> "cement" >> "displayName")), [(getNumber(missionConfigFile >> "Licenses" >> "cement" >> "price"))] call life_fnc_numberText],life_fnc_buyLicense,"cement",0,false,false,"",' !license_civ_cement && playerSide isEqualTo civilian '];
