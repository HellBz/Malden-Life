...
for "_i" from 0 to 1 step 0 do {
    ...
    if (life_isstuned) exitWith {_hideout setVariable ["inCapture",false,true];}; //Stuned
...
if (!alive player || life_istazed || life_isstuned || life_isknocked) exitWith {life_action_inUse = false;_hideout setVariable ["inCapture",false,true];};
